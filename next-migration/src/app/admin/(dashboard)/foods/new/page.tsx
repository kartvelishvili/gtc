import { createFoodAction } from "@/lib/actions/admin";
...
export default function NewFoodPage() {
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-6">New Food</h1>
      <div className="bg-white rounded-lg shadow p-6 max-w-2xl">
        <form action={createFoodAction} className="space-y-4">
